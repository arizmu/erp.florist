        ...
        <div class="mb-6">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p class="text-gray-500 mt-2 ml-1">Lihat detail bahan baku dalam produksi</p>
                </div>
                ...
                <div
                    ...
                    <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700">
                        <div class="flex items-center justify-between">
                            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Daftar Bahan Baku</h2>
                            <div class="flex items-center gap-2">
                                <span
                                    ...
                                    <span x-text="data.length">0</span> Item
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                return {
                    ...
                    getData(url = "") {
                        if (!url) {
                            ...
                            url = `/produksi/produksi-detail-json?${params.toString()}`;
                        }
                    ...
                    calculateTotalValue() {
                        this.totalValue = this.data.reduce((sum, item) => {
                            const totalCost = item.total_cost ? parseFloat(item.total_cost) : 0;
                    ...
                    getProducts() {
                        axios.get('/produksi/get-bahan-baku')
                            .then(res => {
