                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="flex flex-col gap-4">
                                        ...
                                        <div class="relative w-auto">
                                            <select class="select select-floating max-w-sm"
                                            ...
                                            <label class="select-floating-label text-blue-500"
                                                for="selectFloating">Kategori</label>
                                        </div>
                                        <div class="relative w-auto">
                                            <select class="select select-floating max-w-sm"
                                                aria-label="Select floating label" id="selectFloating">
                                            ...
                                            <label class="select-floating-label text-blue-500"
                                                for="selectFloating">Satuan</label>
                                        </div>
                                        <div class="relative w-auto">
                                            <textarea class="textarea textarea-floating peer" placeholder="Hello!!!" id="textareaFloating"></textarea>
                                            <label class="textarea-floating-label"
                                                for="textareaFloating">Comment</label>
                                        </div>
