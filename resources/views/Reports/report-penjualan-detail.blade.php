                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <template x-for="item in data">
                                    <tr>
                                        <td x-text="item.transaction.transaction_date ?? ''"></td>
                                        <td x-text="item.item_name"></td>
                                        <td x-text="item.code_product"></td>
                                        <td x-text="formatRupiah(item.cost_item)"></td>
                                        <td x-text="item.amount_item"></td>
                                        <td x-text="item.transaction.costumer.name ?? '-'"></td>
                                    </tr>
                                </template>
                            </tbody>
                        </table>
