    ...
    <div class="py-4" x-data="helloCrafter">
        ...
        <div class="mb-6">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p class="text-gray-500 mt-2 ml-1">View and analyze your sales transactions</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-12 gap-6">
                ...
                <div class="card shadow-xl border-0">
                    ...
                    <div class="card-header bg-gradient-to-r from-blue-500 to-indigo-600 px-6 py-4">
                        <div class="flex items-center gap-3 text-white">
                            ...
                            <h3 class="text-xl font-bold">Transaction Data</h3>
                        </div>
                    </div>
                            ...
                            <div class="overflow-x-auto">
                                <table class="table">
                                    <thead class="bg-gray-50">
                                        <tr>
                                            <th class="font-semibold text-gray-600">Transaction Code</th>
                                            ...
                                            <th class="font-semibold text-gray-600">Paid</th>
                                            <th class="font-semibold text-gray-600">Unpaid</th>
                                        ...
                                        <template x-for="(item, index) in data" :key="index">
                                            <tr class="hover:bg-blue-50/50 transition-colors">
                                                <td class="font-medium text-gray-800">
                                                    <span class="badge badge-soft badge-primary font-mono text-xs" x-text="item.code"></span>
                                                </td>
                                                <td x-text="item.transaction_date" class="text-gray-600"></td>
                                                <td>
                                                    <span class="badge badge-soft badge-info px-3 py-1" x-text="item.details.length"></span>
                                                </td>
                                                <td class="font-semibold text-green-600" x-text="formatRupiah(item.total_payment)"></td>
                                                <td class="font-semibold text-blue-600" x-text="formatRupiah(item.total_paid)"></td>
                                                <td class="font-semibold text-red-600" x-text="formatRupiah(item.total_unpaid)"></td>
                                                <td class="text-gray-700" x-text="item.costumer ? item.costumer.name : '-'"></td>
                                            </tr>
                                        </template>
                                            ...
                                            <td colspan="7">
                                                <div class="flex flex-col items-center justify-center py-12 text-gray-400">
                                                    <div class="bg-blue-50 rounded-full p-4 mb-4">
                                                        <span class="icon-[tabler--file-invoice-x] size-12 text-blue-400"></span>
                                                    </div>
            ...
            <div class="xl:col-span-3 order-1 xl:order-last">
                <div class="card shadow-xl border-0">
                    <!-- Card Header -->
                    <div class="card-header bg-gradient-to-r from-purple-500 to-pink-600 px-6 py-4">
                        <div class="flex items-center gap-3 text-white">
                        ...
                        <div class="space-y-5">
                            ...
                            <div class="flex flex-col gap-2">
                                <label class="text-sm font-semibold text-gray-700 flex items-center gap-2">
                                    <span class="icon-[tabler--calendar] size-4 text-purple-500"></span>
                                    Period Range
                                </label>
                                <div class="relative">
                                    <input type="text" placeholder="Select date range..."
                                        class="w-full pl-12 pr-4 py-3 bg-white border-2 border-gray-200 rounded-xl text-gray-800 placeholder-gray-400 focus:outline-none focus:border-purple-500 focus:ring-4 focus:ring-purple-500/10 transition-all duration-200 shadow-sm"
                            ...
                            <div class="flex flex-col gap-2">
                                <label class="text-sm font-semibold text-gray-700 flex items-center gap-2">
                                    <span class="icon-[tabler--list-numbers] size-4 text-pink-500"></span>
                                    Data Range
                                </label>
                                <div class="relative">
                                    <select class="select h-12 w-full pl-12 pr-4 py-3 bg-white border-2 border-gray-200 rounded-xl text-gray-800 focus:outline-none focus:border-pink-500 focus:ring-4 focus:ring-pink-500/10 transition-all duration-200 shadow-sm"
