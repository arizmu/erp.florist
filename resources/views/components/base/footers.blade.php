<footer class="footer bg-white flex flex-col items-center gap-4 p-6">
    <div class="flex items-center gap-2 text-xl font-bold">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path
            ...
            fill="oklch(var(--p))"
          /></svg>
      <span class="font-muse text-red-400" style="--fw:600">Naira Gift Florist</span>
    </div>
    <aside>
      <p>©2024ByArissman</p>
    </aside>
    <nav class="text-base-content/90 grid-flow-col gap-4">
